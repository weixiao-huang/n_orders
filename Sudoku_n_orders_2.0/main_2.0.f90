...
!*****************************************************************
!   2.0版本新增功能：
!   1、输入n的数值大于9后，若可以到达目标位置，会提示大概需要
!      运算的时间，并且让使用者选择是否继续
!   2、运算结束后，在屏幕上增加显示了运算所需的时间（time）
!*****************************************************************
...
!  cut the program at line 44 and paste it at line 91.            !
!-----------------------------------------------------------------!

!++++++++++++++++++   2.0版本新增功能源代码1   ++++++++++++++++++++
    if(n>9)then
       t0 = 0.000626 * (n ** 4.09) + 0.6294
       t = ceiling(t0)
        if(t<60)then
          print "(' But it may take ',I2, 's to move')",t
        elseif(t>=60)then
          t11 = ceiling(t0/60)
          t22 = mod(t,60)
          print "(' But it may take about ',I2, 'min',I3,'s to move')", t11,t22
        endif
       print*
       print *,'Please input Y/y to continue, others to exit!'
       read(*,*) c
       if(c /= 'Y' .and. c /= 'y')stop
    endif
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
!++++++++++++++++++   2.0版本新增功能源代码2   ++++++++++++++++++++
    ...
    t2 = secnds(0.0)
    rewind(50)
    write(50, "('t = ', F13.7)")t2-t1
    print "('time =',F10.4)", t2 - t1
    close (50)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
!  若n为奇数则逆序数用k1，否则就用逆序数k2
    ...
    if (.not. judge)print*,"If you want to know more, see line 46 to 49 in the program main."
